#include "AICursedKingOfSwords.h"
...
{
AICursedKingOfSwords::AICursedKingOfSwords(XYZEngine::GameObject* gameObject)
...
void AICursedKingOfSwords::Update(float deltaTime) 
{
